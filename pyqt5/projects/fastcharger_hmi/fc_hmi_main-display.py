...
class uiMain( fc_hmi.Ui_MainWindow, QtWidgets.QMainWindow):
    ...
    def handle_dcdc_json(self, dcdc_id, dic):
         try:
            ...
            self.op_mode[id].setText(dic["softwareMode"] + str(self.imc) + "_" + str(dcdc_id))
    ...
    def handle_crm_json(self,crm_id,dic):
        try:
            ...
            self.crm_status[id].setText(str(dic["crm_health_status"]) + str(self.imc) + "_" + str(crm_id))
            ...
            for i in range(1,9):
                ...
                battery["cell1_" + str(i)].setText(str(bat_json["cell_voltage_1"]) + str(self.imc) + "_" + str(crm_id) + "_" + str(i))
                battery["cell2_" + str(i)].setText(str(bat_json["cell_voltage_2"]) + str(self.imc) + "_" + str(crm_id) + "_" + str(i))
                battery["cell3_" + str(i)].setText(str(bat_json["cell_voltage_3"]) + str(self.imc) + "_" + str(crm_id) + "_" + str(i))
                battery["cell4_" + str(i)].setText(str(bat_json["cell_voltage_4"]) + str(self.imc) + "_" + str(crm_id) + "_" + str(i))
                battery["batV_" + str(i)].setText(str(bat_json["battery_voltage"]) + str(self.imc) + "_" + str(crm_id) + "_" + str(i))
                battery["batI_" + str(i)].setText(str(bat_json["battery_current"]) + str(self.imc) + "_" + str(crm_id) + "_" + str(i))
                battery["batT_" + str(i)].setText(str(bat_json["battery_temp"]) + str(self.imc) + "_" + str(crm_id) + "_" + str(i))
                battery["comm_" + str(i)].setText(str(bat_json["comm_status"]) + str(self.imc) + "_" + str(crm_id) + "_" + str(i))
    ...
    def handle_mrs_json(self,mrs_id,dic):
        try:
            ...
            for i in range(1,14):
                self.mrs_analogs[id][i-1].setText(str(dic["AnalogChannel"+str(i)]) + str(self.imc) + "_" + str(mrs_id))
    ...
    def handle_system_json(self,dic):
        ...
        self.textEdit_system_status.setText(str(dic["faults"]) + "_" + str(self.imc))
